...
string DownloadThreadCoordinationTest::downloadedData;
mutex DownloadThreadCoordinationTest::downloadingDataMtx;
mutex DownloadThreadCoordinationTest::downloadingCompleteMtx;
mutex DownloadThreadCoordinationTest::printMtx;
bool DownloadThreadCoordinationTest::downloadComplete;
bool DownloadThreadCoordinationTest::downloadDataUpdated;

void DownloadThreadCoordinationTest::Run()
{
	//init
	downloadedData = "";
...
void DownloadThreadCoordinationTest::DownloadWork()
{
